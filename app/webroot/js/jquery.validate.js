...
}, $.format("Por favor, entre com {0} palavras ou menos.")); 
 
jQuery.validator.addMethod("minWords", function(value, element, params) { 
    return this.optional(element) || value.match(/\b\w+\b/g).length >= params; 
}, $.format("Por favor, entre com ao menos {0} palavras.")); 
...
}, "Por favor, use apenas letras, números, spaços ou underline.");  
...
}, "Sem espaços em branco, por favor."); 